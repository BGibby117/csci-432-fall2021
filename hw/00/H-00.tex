...
\begin{enumerate}
    ...
    \item In this class, please properly cite all resources that you use. Please
        ...
        \paragraph{Answer}
        Plagarism: to use another person's work, but under the guise that the work is your own.
    ...
    \item If you have observed plagiarism or cheating in a classroom (either as
        ...
        \paragraph{Answer}
        https://jesuitroundup.org/viewpoint/viewpoint-student-life/cheating-why-do-students-do-it/ //
        To witness cheating would disgust me, not only because I think it's wrong, but also because its such blatant self-sabotage. It would also question my high-expectations for my peers.}
\end{enumerate}
...
\begin{enumerate}
    \item What is the definition of an odd number?
        ...
        \paragraph{Answer}
        \todo{An odd number is any even number plus one. I.e. for any integer $a$, $2a + 1$ is odd.}
